...
ALTER TABLE public.orderdetail
    ADD CONSTRAINT orderdetail_pkey PRIMARY KEY (orderid, prod_id), --revisar duplicado
    ADD CONSTRAINT orderdetail_orderid_fkey FOREIGN KEY (orderid) 
        REFERENCES public.orders (orderid) MATCH SIMPLE --revisar match
        ON UPDATE CASCADE ON DELETE SET NULL, --revisar cascade set null
...
ALTER TABLE public.orders
    ADD CONSTRAINT orders_customerid_fkey FOREIGN KEY (customerid) 
        REFERENCES public.customers (customerid) MATCH SIMPLE --revisar match
        ON UPDATE CASCADE ON DELETE SET NULL; --revisar cascade set null